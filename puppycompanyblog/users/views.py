...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user.check_password(form.password.data) and user is not None:
            ...
            next = request.args.get('next') #to check what the user was trying to acces before getting redirected to login page
...
def user_posts(username):
    page = request.args.get('page',1,type=int) #to implement pagnation
